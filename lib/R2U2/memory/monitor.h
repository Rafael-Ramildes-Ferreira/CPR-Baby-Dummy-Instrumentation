...
#define R2U2_DEFAULT_MONITOR \
  { \
    ...
    (reinterpret_cast<uint8_t (*)[]>(&(uint8_t [R2U2_MAX_INST_LEN]){0})), \
    (reinterpret_cast<r2u2_instruction_t (*)[]>(&(r2u2_instruction_t [R2U2_MAX_INSTRUCTIONS]){0})), \
    NULL, NULL, \
    (reinterpret_cast<void* (*)[]>(&(void*[R2U2_MAX_SIGNALS]){0})), \
    (reinterpret_cast<r2u2_value_t (*)[]>(&(r2u2_value_t [R2U2_MAX_BZ_INSTRUCTIONS]){0})), \
    {(reinterpret_cast<r2u2_bool (*)[]>(&(r2u2_bool [R2U2_MAX_ATOMICS]){0})), (reinterpret_cast<r2u2_bool (*)[]>(&(r2u2_bool [R2U2_MAX_ATOMICS]){0}))}, \
    {(reinterpret_cast<r2u2_bool (*)[]>(&(r2u2_bool [R2U2_MAX_INSTRUCTIONS]){0})), (reinterpret_cast<r2u2_bool (*)[]>(&(r2u2_bool [R2U2_MAX_INSTRUCTIONS]){0}))}, \
    (reinterpret_cast<uint8_t (*)[]>(&(uint8_t [R2U2_MAX_BOXQ_BYTES]){0})), \
    (reinterpret_cast<uint8_t (*)[]>(&(uint8_t [R2U2_MAX_SCQ_BYTES]){0})), \
    (reinterpret_cast<r2u2_at_filter_aux_data_t (*)[]>(&(r2u2_at_filter_aux_data_t [R2U2_MAX_AT_INSTRUCTIONS]){0})), \
  }
